        ...
        if(!empty($sessticket['book']))
        {
            ...
            if(!empty($bookingid)) {
                ...
                foreach ($visitor as $k => $v) {
                    ...
                    $sqlV = "INSERT INTO `visitor` (`bookingid`, `category`, `adult`, `adultrate`, `totalamount`) VALUES ($bookingid, '$k', $adult, $adultrate, $totalamount)";
                ...
                $sqlIn = "INSERT INTO `invoice` (`bookingid`, `transactionid`, `adult`, `visitoramount`, `photography`, `photographyamount`) VALUES ($bookingid, '$transId', $tladult, $visitoramount, '$ptype', $pamount)";
