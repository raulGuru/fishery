    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav">
            <ul class="nav in" id="side-menu">
                ...
                <li> <a href="searchticket.php" class="waves-effect <?php echo ($active == '2' ? 'active' : ''); ?>"><i class="mdi mdi-chart-areaspline fa-fw"></i> <span class="hide-menu">Search Ticket<span class="fa arrow"></span><span class="label label-rouded label-warning pull-right">30</span></span></a>
                </li>
